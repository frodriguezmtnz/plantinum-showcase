  ...
  return (
    <section className="container py-8 md:py-12">
      <div className="text-center mb-8">
        <p className="field-mark">The full board</p>
        <h1 className="mt-1 text-4xl md:text-5xl font-bold tracking-tight font-headline text-balance">Explore the Gallery</h1>
